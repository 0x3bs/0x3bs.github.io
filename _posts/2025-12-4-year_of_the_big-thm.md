...
![](\assets\images\thm\year_of_the_pig\0png.png)
...
![](\assets\images\thm\year_of_the_pig\1.png)

mmmmmmm it's redirect us to `.../login.php/` and after typing any this in these fields it's give us a hint about password which is the password should be a memorable word (for marco) and followed y 2 numbers and 1 special char . 

Okay let's go back to the blog to find any hints >>

![](\assets\images\thm\year_of_the_pig\2.png)

this was the hind which is `Savoia S.12` .... So the password should be like that >>
...
![](\assets\images\thm\year_of_the_pig\4.png)

let's show it using `burp suite` :

![](\assets\images\thm\year_of_the_pig\5.png)

So the password send as `md5` hash in `.../api/login`
...
![](\assets\images\thm\year_of_the_pig\7.png)
...
![](\assets\images\thm\year_of_the_pig\6.png)
...
![](\assets\images\thm\year_of_the_pig\9.png)
